...
export default function DisplayInitiative() {
    ...
    return (
    <div>
        <Button variant="outline-primary" size="lg" onClick={() => setQuickAddOpen(true) }>Quick Add Character</Button>
        ...
        <Table striped bordered hover>
            ...
            <tbody>
                {initiativeCreatures.map((creature,index) => <tr key={index}>
                    <td>{index + 1}</td>
                    <td>{creature.name}</td>
                    <td>{creature.ac}</td>
