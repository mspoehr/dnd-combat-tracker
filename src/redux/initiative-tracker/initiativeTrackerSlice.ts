...
export const selectInitiativeCreatures = (state: RootState) => state.initiativeTracker.creatures;

export const selectSortedInitiativeCreatures = createSelector(
  selectInitiativeCreatures,
  (creatures) => [...creatures].sort((a,b)=>{ return (b.initiative ?? 0) - (a.initiative ?? 0) })
);
